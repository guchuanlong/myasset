 ...
 * @version 2019-05-27
 */
public class PandianResultHis extends DataEntity<PandianResultHis> {
	...
	private Date historyTime;		// 操作时间
	private String historyRemark;		// 进入历史表备注
	private String historyLoginName;		// 操作人
	private String historyUserId;		// 进入历史操作人id
	
	public PandianResultHis() {
		super();
	}

	public PandianResultHis(String id){
		super(id);
	}
	...
	@Length(min=0, max=11, message="盘点状态长度必须介于 0 和 11 之间")
