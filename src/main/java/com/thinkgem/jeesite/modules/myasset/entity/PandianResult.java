 ...
 * @version 2019-05-16
 */
public class PandianResult extends DataEntity<PandianResult> {
	...
	private Date baseDate;		// 导入时间
	private Date resultDate;		// 盘点时间
	
	public PandianResult() {
		super();
	}

	public PandianResult(String id){
		super(id);
	}
	...
	@Length(min=1, max=11, message="盘点状态长度必须介于 1 和 11 之间")
	@ExcelField(title="盘点结果", align=2, sort=80, dictType="pandian_result_status")
	...
	@Length(min=0, max=50, message="盘点状态长度必须介于 0 和 50 之间")
