...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/myasset/busiBorrowBill/detail?id=${busiBorrowBill.id}">资产领用详情<shiro:hasPermission name="myasset:busiBorrowBill:edit">${not empty busiBorrowBill.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="myasset:busiBorrowBill:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	...
	<%@include file="/WEB-INF/views/modules/myasset/ejectChooseAssetListDetail.jsp" %>
	</form:form>
